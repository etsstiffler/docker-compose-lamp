...
useradd --create-home -d /storage/ftp/joomla2 --shell /bin/bash --no-user-group joomla2
usermod -g "$FTP_USER" joomla2
echo "joomla2":"joomla2" | chpasswd

useradd --create-home -d /storage/ftp/joomla3 --shell /bin/bash --no-user-group joomla3
usermod -g "$FTP_USER" joomla3
echo "joomla3":"joomla3" | chpasswd

useradd --create-home -d /storage/ftp/joomla4 --shell /bin/bash --no-user-group joomla4
usermod -g "$FTP_USER" joomla4
echo "joomla4":"joomla4" | chpasswd

useradd --create-home -d /storage/ftp/joomla5 --shell /bin/bash --no-user-group joomla5
usermod -g "$FTP_USER" joomla5
echo "joomla5":"joomla5" | chpasswd

useradd --create-home -d /storage/ftp/joomla6 --shell /bin/bash --no-user-group joomla6
usermod -g "$FTP_USER" joomla6
echo "joomla6":"joomla6" | chpasswd

useradd --create-home -d /storage/ftp/joomla7 --shell /bin/bash --no-user-group joomla7
usermod -g "$FTP_USER" joomla7
echo "joomla7":"joomla7" | chpasswd

useradd --create-home -d /storage/ftp/joomla8 --shell /bin/bash --no-user-group joomla8
usermod -g "$FTP_USER" joomla8
echo "joomla8":"joomla8" | chpasswd

useradd --create-home -d /storage/ftp/joomla9 --shell /bin/bash --no-user-group joomla9
